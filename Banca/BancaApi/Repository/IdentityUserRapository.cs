...
using KafkaProducer.Service.KafKa;
using RedisCache.Service.IRedisService;
...
namespace BancaApi.Repository
{
    public class IdentityUserRapository : IIdentityUserRapository
    {
        ...
        private readonly ICorrentistaService _corr;
        private readonly IDipendenteService _dip;
        ...
        public IdentityUserRapository(UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager, RoleManager<IdentityRole> roleManager, ICorrentistaService corr, IDipendenteService dip, 
            IJwtTokenGenerator jwtTokenGenerator, IRedisP redisP, IKafKaProducers prod, IConfiguration config)
        {
